...
import app.akshay.ta.di.component.DaggerActivityComponent;
import app.akshay.ta.di.module.ActivityModule;
import app.akshay.ta.util.CommonUtils;
import app.akshay.ta.util.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity implements MvpView, BaseFragment.Callback{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((TApp) getApplication()).getmApplicationComponent())
                .build();
    }
